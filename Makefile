...
multiverse-cosmology-v0.4.x.xhtml: multiverse-cosmology-v0.4.x.docbook5.xml
...
why-the-so-called-real-world-i-am-trapped-in-makes-little-sense--2020-05-19.xhtml: why-the-so-called-real-world-i-am-trapped-in-makes-little-sense--2020-05-19.docbook5.xml
	docmake -v --stringparam "docbook.css.source=" --stringparam "root.filename=lib/docbook/5/essays/The-Enemy-English-v7/all-in-one.xhtml.temp.xml" --basepath /usr/share/sgml/docbook/xsl-ns-stylesheets -x "$${homepage:-$$HOME/Docs/homepage/homepage/trunk/}"/lib/sgml/shlomif-docbook/xsl-5-stylesheets/shlomif-essays-5-xhtml-onechunk.xsl -o $@ xhtml5 $<

render: why-the-so-called-real-world-i-am-trapped-in-makes-little-sense--2020-05-19.asciidoc
render: why-the-so-called-real-world-i-am-trapped-in-makes-little-sense--2020-05-19.xhtml
