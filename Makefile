...
multiverse-cosmology-v0.4.x.xhtml/all-in-one.xhtml.temp.xml.xhtml: multiverse-cosmology-v0.4.x.docbook5.xml
...
render: multiverse-cosmology-v0.4.x.xhtml/all-in-one.xhtml.temp.xml.xhtml
