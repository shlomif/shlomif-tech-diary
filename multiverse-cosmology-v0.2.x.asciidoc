...
* https://en.wikipedia.org/wiki/G%C3%B6del,_Escher,_Bach[Godel,_Escher, Bach]
...
The devils challenged angels with The-Game: they would willingly lose their earlier memories as souls, and have their media (= "in between") mutated by the devils. Physically dying was against the rules, but for true Shalom-of-mind, they must be "slain" by another "vampire"; one cannot constantly win.
