...
So does God exist? There were two stages of my life as a vampir hacker when I found it reasonable to suspect that "God" did not exist ( but I naturally was not 100% certain that that was indeed the case given being sure required a proof). However, even during then I applied reason, logic, judgement (including from past experience), knowledge, love, humour, imagination, etc.
