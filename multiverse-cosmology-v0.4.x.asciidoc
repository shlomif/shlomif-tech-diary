...
Muppets Franchise] has been a labour of love by many false prophets and true prophets, by 1969, it was accepted that there were three head Muppeteers ( https://en.wikipedia.org/wiki/The_Three_Musketeers[pun intended with The Three Musketeers] ), all false prophets: 
