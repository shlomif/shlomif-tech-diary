...
As the two argue in the blog's comments, https://mlp.fandom.com/wiki/Discord[Discord (from My Little Pony)] notes that "Advanced Selinaverse Geeks" has been a popular fantasy role-playing games' franchise in Equestria for years. 
...
Furthermore, not only were the gamemasters bastards, but they were - to use the technical term - link:#hackers[fuckers]! 
...
Rule book is common knowledge among wizards, but hidden from vampires: 

* 1 × 2 core concepts. 
* 3 × 2 concepts ("soul, time, life, mind, knowledge"??) 
...
In my case, my watcher from ~1989 until ~1997 was https://en.wikipedia.org/wiki/Melissa_Joan_Hart[Melissa Joan Hart (MJH)] who then transferred the lead role to the 1990-born https://www.shlomifish.org/meta/nav-blocks/blocks/#harry_potter_nav_block[Emma Watson].
...
He also has yet to answer 'no' to the question "is [insert entity here] a pure Jew?". Note that "rav", which means "great" in archaic Hebrew, means both "proliferous" and "argumentative" in Modern Hebrew. footnote:[A similar strategy was employed by the USA ("give me your tired, your poor, your huddled masses"),
...
* link:#Real-Selina-Mandrake[Selina], who is younger than him, stubbornly insisted that she'll be a dropout. As a result, that universe could not be named after us. 
...
. https://www.shlomifish.org/humour/bits/facts/Taylor-Swift/[Taylor Swift] - 
. https://www.facebook.com/vendu/[Tuomo Vendu Venäläinen]
. https://en.wikipedia.org/wiki/Kim_Kardashian[Kim Kardashian]
