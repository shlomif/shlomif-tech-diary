...
* DARPA/ARPA: "`When DARPA fails, big industries spring up`"
*
*
*
...
E.g:    * conCERN: where HTTP/WorldWideWeb were invented  * The smartphone wars: lawyers are often "showy" SysCo.
