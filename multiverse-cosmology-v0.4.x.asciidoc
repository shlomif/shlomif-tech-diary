...
As a result, I think that if we accept the definition of "God" in TheCodex(TM) of TheGameOfSeekers(TM) of Fantastecha(TM), then they most probably do exist, given practically every conscious-and-mindful Selinaverse-an organism, has some amount of self-control and guidance.
