...
*Note:* to further this cause, I hereby request that 70% of the past and future donations to me (whether money, love points, exprience points, mana, or whatever, except perhaps https://twitter.com/shlomif/status/1571008285326835713[those of physical traits and parameters]) will be transferred to her. 
...
Given Africa was one big country https://en.wikipedia.org/wiki/Necho_II[Necho II]'s expedition had one slayer vampire from the Levant (Lebanon, Israel, Damascus) on every ship, in order to try to liberate the African provinces.
