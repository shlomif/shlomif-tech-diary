...
Then they decide to play "The game" with the classic, possibly cliché, campaign of link:#history-lesson-about-the-muppeteers[the Muppeteers in 1969] with Fluttershy and Monroe as arbiters, thus starting the cycle again. 
____
...
However, light speed as an upper bound, is a useful constraint that, after it was upheld, made technology better designed. 
...
The adult Muppeteers and other post-puberty false prophets read it, smiled/laughed/cried/etc.
...
) slew as a child were not the USSR and the USA, but link:#zionism[Ziyoonism] and Jim Henson/The Muppeteers! footnote:[See
...
The-Codex(TM) recognises "Corporations" (= many bodies), which can be as small as a regional games' club, or as large as https://buffyfanfiction.fandom.com/wiki/Q_Continuum_(Selinaverse)[the Q Continuum]. 
...
https://www.explainxkcd.com/wiki/index.php/406:_Venting[xkcd #406: venting] displaying "Shlomi Fish" for https://www.shlomifish.org/meta/nav-blocks/blocks/#xkcd_sect[Summer Glau]. 
