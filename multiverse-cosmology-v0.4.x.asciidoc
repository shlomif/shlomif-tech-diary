...
Given Africa was one big country https://en.wikipedia.org/wiki/Necho_II[Necho II]'s expedition had one slayer vampire from the Levant (Lebanon, Israel, Damascus) on every ship, in order to try liberate the African provinces.
