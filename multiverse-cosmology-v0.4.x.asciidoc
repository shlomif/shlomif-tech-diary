...
The meta- Fantastechans who play TheGame(TM) have some more esoteric qualities such as fondness of the number 10 (= "ten", 0b1010) and its powers. 
...
Physically dying was against the rules, but for true Shalom-of-mind, they must be "slain" by another "vampire", or in case of the last standing vampire - the "child" of their two favourite "children" [= protege]; one cannot constantly win. 
