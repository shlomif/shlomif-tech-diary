...
Magic might be defined as any transformation of the state of link:# the-network["the network"]: the extended graph theory graph which is our universe. 
...
** https://www.shlomifish.org/Files/files/text/end-game-for-shlomif-as-a-false-prophet.xhtml[XHTML5 version]
