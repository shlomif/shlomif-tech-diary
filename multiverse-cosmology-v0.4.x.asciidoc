...
$GOD (written using medieval-style chapter-opening letters) is the hypothetical entity, who set link:#the-multiverse-of-imagination[Fantasia] on motion, given having only an abyss of nothingness / non-existence would be far less fun. 
...
.. link:#love-and-knowledge[Knowledge] - education and creation/conception - what yields the most pleasure. 
+
