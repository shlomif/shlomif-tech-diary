...
Planet Earth is not fully symmetric, which given https://en.wikipedia.org/wiki/Perfection#Paradoxes["Perfection is in imperfection"] would imply it would have been boring, if not lifeless). 
