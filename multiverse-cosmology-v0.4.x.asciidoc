...
The "soul" / "ego" already https://www.shlomifish.org/philosophy/philosophy/putting-all-cards-on-the-table-2013/indiv-nodes/dont_just_go_with_the_flow.xhtml[operated by choice]. 
...
The link:#the-devils[devils] challenged Terran link:#the-angels[angels] with "`The-Game(TM)`": volunteering link:#hackers[hackers] would willingly lose their earlier memories as souls, and have their media (= "in between") mutated by the link:#the-devils[devils].
...
(See https://en.wikipedia.org/wiki/Rashomon_effect[the Rashomon effecangelst].) 
...
. A hacker may be required or may opt to change his/her "form": name. 
...
So my soul+mind were effectively created in September 1983, at the first day of the 1st grade of elementary school with the body of a 6 years old. 
