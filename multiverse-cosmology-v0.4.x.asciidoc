...
. Xerxes slew Vashti. Given he was pre-pubescent, they did not beget a new vampirepair of children. 
. Xerxes slew Hadassah. She became queen Esther, and the "s" and "t" in succession indicate her wizard-hood. 
+
Given Xerxes pre-pubescent, they did not beget a new vampirepair of children. 
+
...
. Mordechai slew Xerxes, thua de-hell-holing Susa. Xerxes was still pre-pubescent at the time, so he became the last https://en.wikipedia.org/wiki/Achaemenid_dynasty[Achaemenid ["`Persian`"] dynasty] emperor to be born a vampire. And Susa will usually be avoided by post-puberty vampires, given it is no longer a hellhole. 
