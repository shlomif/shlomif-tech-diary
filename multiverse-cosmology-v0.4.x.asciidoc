...
This essay aims to document the cosmology of our universes, . I likely got many details wrong: numbers, names, facts. 
...
While it is one of the first games that wizard children are taught, many vampires have played it by instict: 
...
Anyway, the link:#the-devils[devils] and the link:#the-orcs[orcs] approached the men and women who just reached enlightenment, and offered them a choice: they can opt to spend the summer enlightened and together having fun and using their magical powers.
...
Having terminated link:#Arnold_Schwarzenegger[Arnold Schwarzenegger], https://en.wikipedia.org/wiki/Melissa_Joan_Hart[Melissa Joan Hart (MJH)], and Samantha Smith, the two of us were afterward kept in the same elementary school classroom with few other false prophets. link:#Richard_Stallman[Richard Stallman] and link:#Clarissa_Darling[Clarissa] likely were terminated shortly afterwards. 
