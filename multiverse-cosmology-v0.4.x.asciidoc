...
Note that large parts of my "God" may be inanimate: robots that lack souls, but given few if any fairies care about them, they just were assumed to be there with given side effects, at least.
For example, in some scientific contexts, the sun has over 10**57 atoms at any given split second.
If all of them were gone, planet Earth, would not be able to support human/etc.
life . But not all of them are modelled in the Shlomiverse given most such numbers are not prestigious enough. 
