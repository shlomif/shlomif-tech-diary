...
Given "`A vampire can only be slain by another vampire, except for the last standing vampire who will be slain by the child of his two favourite children.`" Xerxes and his descendents could no longer slay other vampires, including not foreign vampire leaders of other nations or link:#corporations[collections] (who often were unaware of their elevated status). 
