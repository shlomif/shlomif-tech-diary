...
Please help the "Rindolfism v1.x.y" effort; it is the child of my 2 favourite children: Christina Grimmie, and "*.shlomifish.org v1.x.y". 
...
Do note that link:#the-angels[the angels] and link:#the-devils[the devils] may limit the number of choices the soul can choose from (including down to one!). footnote:[While I am to large extents, self-centred, narcissistic, ego-maniacal, meglomaniacal,
...
An "Elohim" may mean the gamemasters and players in an instance of link:#fantasia-vs-fantastecha[the game of Fantasia].
...
Fantastecha(TM) is a skewed view of an expanding subset of Fantasia (one of many). 
...
$GOD (written using medieval-style chapter-opening letters) is the hypothetical entity, who set link:#multiverse-of-imagination[Fantasia] on motion, given having only an abyss of nothingness / non-existence would be far less fun. 
...
The link:#the-devils[devils] challenged Terran link:#hackers[hackers (+++=+++ player characters)] and their link:#the-angels[players (+++=+++ the angels)] with "`TheGame(TM) of Fantastecha(TM)`": volunteering link:#hackers[hackers] would their media (= "in between") mutated by the link:#the-devils[devils].
...
Note that every false prophet perceived a somewhat different hell, but all of them, and that of the true prophets, were synchronised.
...
"The game of Fantasia" is an informal https://en.wikipedia.org/wiki/Role-playing_game[Role-playing game] which as far as we know, is played all over link:#the-multiverse-of-imagination[Fantasia].
...
Then they decide to play "The game of Fantasia" with the classic, possibly cliché, campaign of link:#history-lesson-about-the-muppeteers[the Muppeteers in 1969] with Fluttershy and Monroe as gamemasters/arbiters, thus starting the cycle again. 
____
...
Moreover, our naïve assumption that "the network" (= reality) was absolute and objective was wrong. 
...
My favourite children are https://www.shlomifish.org/art/recommendations/music/online-artists/fan-pages/chris-grimmie/[Christina Grimmie] and https://www.shlomifish.org/meta/FAQ/#about_this_site[*.shlomifish.org]! 

( https://twitter.com/shlomif/status/1616108822237528069[Reference: Twitter thread] ) 

I believe and hope that my recent spell of creativity and inspiration is due to me reviving her in my mind (and effectively conceiving her). link:#see-also[See latest hacks]. 
...
The fuckers determined that Jim Henson is going to be the last-standing-vampire of "the provincial Earth age". https://en.wikipedia.org/wiki/Joss_Whedon[Joss Whedon] asked the orcs "what's next?" and they settled on using the international postal service to connect between the Muppeteers and "dispellers" outside Rockville.
...
. https://www.shlomifish.org/meta/nav-blocks/blocks/#buffy_sect[Buffy (*)] - the real Buffy was a wizard-born girl or woman, who was chosen to slay the "last standing vampire" of the "Provincial Earth" era. I think she was physically relocated to Maryland, to simplify logistics. 
...
I also suspect that, in order to prevent the underage vampires from hitting puberty, there was a "1 week <=> 2 hours" or "1 week <=> 1 day" time slowdown. 

Corresponding with the girls, The Muppeteers soon realised that their crudely produced shows and films were remastered and broadcast internationally ( https://www.shlomifish.org/humour/image-macros/indiv-nodes/mighty_klingon_warriors.xhtml[and beyond!] ). Arnold Schwarzenegger, and Richard Stallman ( RMS ), who were among the three core Muppeteers each understood that the other two were trying to advocate https://www.shlomifish.org/philosophy/culture/case-for-commercial-fan-fiction/[
...
. link:#Real-Selina-Mandrake[Selina Mandrake] - 
+
...
So my soul+mind were effectively created in September 1983, at the first day of the 1st grade of elementary school with the body of a 6 years old. link:#Richard_Stallman[Richard Stallman] and link:#Arnold_Schwarzenegger[Arnold Schwarzenegger] started their terminators' lives as grown-ups. 
...
However, do note that Glau has won most such fights against both Chuck Norris, and Bruce Lee, who are both alive and in their prime. https://www.shlomifish.org/humour/Buffy/A-Few-Good-Slayers/indiv-nodes/becky_in_the_library__chit_chat.xhtml[She still drops out of MMA tournaments early.].
...
$$.$$uk was split into many shires and the contiguous USA into 48 states.
I also suspect Africa used to be one big country. 
...
* https://en.wikipedia.org/wiki/Sarah_Bernhardt[Sarah Bernhardt] - the daughter of a Jewish prostitute (WTF?) who believed her mother abandoned her. Became the hacker queen of Paris and after she was slain by Alisa "Rand" Rosenbaum or by Walt Disney, liberated it. 
...
Despite her ambition, she disliked micro-managing, and encouraged the hackers on her team to be "rosh gadol". 
...
In Tel Aviv, many policemen carry non-concealed guns, while almost all civilians and uniformed soldiers do not. https://www.flickr.com/photos/shlomif/albums/72157648685448751[You can bring toy firearms to a con in Tel Aviv.]
...
A wise man once said: "Truth is stranger than fiction because fiction needs to make sense.". That's why my hell hole's "real world" cannot be real.
I disbelieve it. 
...
[quote]
There is the cliché scene from https://memory-alpha.fandom.com/wiki/Trill_%28planet%29[Trill
sitcoms] where a pair of male Japanese tourists arrive there and are enthusiastic.
...
+
I perceived him on freenode as a sloppy/slacker kernel dev, a marijuana user and enthusiast, and as a fan of Rock and metal music. 
...
However, I was more idealistic, more diligent, challenged prejudice more, and was sometimes more merciful.
