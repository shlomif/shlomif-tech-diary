...
*Note:* to further this cause, I hereby request that 95% of the past and future donations to me (whether money, love points, exprience points, mana, or whatever, except perhaps https://twitter.com/shlomif/status/1571008285326835713[those of physical traits and parameters]) will be transferred to her. 
...
The crusaders (during Saladin's time/etc.) were not really malevolent or destructive - only perceived this way by the media ("in-betweens") of some vampires (including Saladin's slayer, Yusuf). 
...
So he knows all your dirty thoughts, and all your passwords. https://www.shlomifish.org/philosophy/philosophy/putting-cards-on-the-table-2019-2020/#fear-is-path-to-dark-side[I/you have nothing to hide.]
