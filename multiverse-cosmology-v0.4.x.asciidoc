...
The-Codex(TM) defines "hacker" as a player character in Fantastecha(TM). It also defines "fuckers" as the race of organisms who are the players and gamemasters who 
