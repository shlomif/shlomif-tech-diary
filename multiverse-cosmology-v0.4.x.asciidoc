...
TheCodex(TM) of TheGame(TM) of Fantastecha(TM) defines "God" (with no "a/an/some" grammatical articulation, preferably with an uppercase "G", and commonly called "Elohim" in idiomatic modern Hebrew) as each and every entity (whether inside Fantastecha(TM) or outside), which can influence a hacker`'s present or future: co-hackers living in the same universe, the para-Fantastechans, the para-para-Fantastechans (etc.), his angels and devils, his characters or other "game pieces" 
