...
* https://en.wikipedia.org/wiki/Alexandre_Dumas[Alexandre Dumas, père] - reportedly had 40 affairs, despite being married, and appearing to be a fan of long-term, romantic, intimate, relationships in https://en.wikipedia.org/wiki/The_Three_Musketeers["`The Three Musketeers`"] and https://en.wikipedia.org/wiki/The_Black_Tulip["`The Black Tulip`"]. 
...
. I suspect that female terrans were historically excluded from parts of the workforce due to the tendency of vocal minorities out-of-them to constantly complain/"bitch" about trivialities. 
