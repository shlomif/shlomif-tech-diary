...
The story of Jim Henson continues in link:#last-standing-vampires[here]. 
...
https://www.shlomifish.org/art/recommendations/music/online-artists/fan-pages/chris-grimmie/[Christina Grimmie] in my case, and Buffy in Henson's. 

We were made to think they "turned to the dark side" and were killed. 
|
...
// 
// <para>
// In Henson's case it was <link xlink:href="https://en.wikipedia.org/wiki/Joss_Whedon">Joss Whedon</link>.
// </para>
// 
// <para>
// In mine, it was <link xlink:href="#shlomif-watchers-and-whichers">MJH→Emma Watson</link>.
// </para>
// 
// </entry>
