...
I wish to live on a spherical planet with a 24 hours clock, and https://en.wikipedia.org/wiki/Gregorian_calendar . However, there should be no risk of environmental or astronomical calamities.
...
We cannot stop even small children from imagining things - and elsewhere in Fantastecha, there will be sucker/brave souls who will choose to start their life as false prophets.
 Given good narratives feature one problem or more that need to be reconciled.

Furthermore, I sided with Emma Watson that "your time is everybody's time" rather than MJH's liberal use of time wraps. Thids
