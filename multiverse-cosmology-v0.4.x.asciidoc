...
Do note that link:#the-angels[the angels] and link:#the-devils[the devils] may limit the number of choices the soul can choose from (including to one!). 
...
. Mind - a hacker's model of the Network. 
