...
Note that both Schwarzenegger and Stallman were outliers as far as Jim Henson, who believed that muppeters must be fairly strong, flexible, and agile, but not obese, or overly muscular.
