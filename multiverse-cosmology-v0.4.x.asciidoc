...
*Update:* I thought to call it "`Grindolfism v2.0.x`" given "Grindolfism" sounds very close to "Rindolfism". Or "`Grimmidolfism`" or "`GrimmidolfHitlowerism`" or similar. 
...
For the sake of "TheTrackersGame(TM) of Fantastecha(TM)", there are two major kinds of fairies: link:#hackers["Hackers" and "Seraphs"]. 
...
In TheGameOfSeekers(TM) a hacker`'s "`body`" is the subset of their form that pertains to their physical part of "the network". 
...
* "Zayin" in ancient Hebrew meant a "weapon". As a result, trackers are led astray to teach them lessons and provide them with wisdom and experience. 
* Zine is fond of experiences that were not experienced or thought about recently. 
...
TheCodex(TM) calls an arbiter or gamemaster in an instance of link:#fantasia-vs-fantastecha[the role-playing game of Greater Fantasia] a "devil". "The Satans" are such link:#hackers[Meta-Fantastecha(TM)ns] acting as devils in TheGameOfTrackers(TM) of Fantastecha(TM). They claim they are not really malevolent, just playfully cruel on occasion. 
...
[[_the_multiverse_of_imagination]]
...
Moreover, while most of its narrative and content, seemed to be reasonable, coherent and believable to me (even as a vampire who started as a "rationality"-ist/"science"-ist person, who thought that supernatural magic did not exist), in the Selinaverse, many of the Tanakh's characters lived (including as pre-slain vampires) in different times, and did different things (including those attributed to other characters). And none of them ever perished (= "physically died") or literally massacred other hackers (including humans, vampires, or even non-primate mammals and birds). 
...
Anyway, TheCodex(TM) of TheGameOfTrackers(TM) of Fantastecha(TM) was kept secret from the link:#hackers["hackers (= player characters)"] of the Selinaverse and was to be revealed to the Terminal Terran Terminator (me?). 
...
circular logic, circular feedback, etc.] are common in Fantastecha(TM), and part of what makes sentience and soome kinds of humour work: 
...
"`Trackers`" are the Hackers who are being played in TheGameOfTrackers(TM) of Fantastecha(TM), and by the nature of love-and-knowledge, perpetuate other Trackers and hackers, and universes thereof. 

[[_the_heart_and_mercy_value]]
...
It is likely that https://en.wikipedia.org/wiki/Egyptian_pyramids[the Egyptian pyramids] and their fan-art https://en.wikipedia.org/wiki/Mesoamerican_pyramids[Mesoamerican pyramids] were constructed using magic by gods.
They may have also been conjured almost instanteously, as alternate-historical evidence. footnote:[The same logic may be applied to the World War II "evidence" of the Nazi concentration camps and death camps.]

Black Magic is initiated by the link:#the-devils[the gamemasters] in order to keep TheGameOfSeekers(TM) of Fantastecha(TM) challenging. 

Magic might be defined as any surprising and unexpected transformation of the state of link:#the-network["the network"]: the extended graph theory graph which is the state of our universe. 
...
I use all of XML, YAML, JSON, Perl, Python 3, C, vlc, mpv, duckduckgo, google [ https://www.shlomifish.org/meta/FAQ/[Reference: my FAQ] ]. 
...
$GOD may also be the link:#hackers[Seraphs'] Elohim's Elohim's Elohim's... to the end (or infinity?). 
...
I recall my father telling me that bridges in China were built crooked because they believed ghosts always walked in straight lines. footnote:[I think now that outside my hell, the horse, who was/is a wizard hacker, was
...
As a result, I think that if we accept the definition of "God" in TheCodex(TM) of TheGameOfSeekers(TM) of Fantastecha(TM), then they most probably do exist, given practically very conscious-and-mindful Selinaverse-an organism, has some amount of self-control and guidance.
...
are too beautiful and/or logic/science - defying to have been fully conceived by soulless entities. 

[[_mind_control]]
=== Mind control, unthinkablity

As a "rationality"-ist, somewhat timid, and even paranoid-at-times, and anti-cynical, optimistic, humans/humanity/life-loving (but somewhat too naïve), vampire, I https://www.shlomifish.org/philosophy/culture/multiverse-cosmology/why-the-so-called-real-world-makes-little-sense/#evidence-that-this-hell-isnt-real[accepted many true-isms which I now think were too farfetched to take for granted], from "the real world" being perceived in an absolute manner ("`Objectivism`"?), to magic not existing, to the hell-"`world`" supply and transportation of many elements from chocolate beans and their by products, to very rare metals and other minerals, to oil, which are all moved across thousands of kilometres using extremely-heavy-and-big ships-and-aeroplanes, that should have burned oil like there's no tomorrow. 
...
[[_the_game]]
== TheGameOfSeekers(TM) of Fantastecha(TM):

The link:#the-devils[devils] challenged Terran link:#hackers["hackers (= player characters)"] and their link:#the-angels["players (= the angels)"] with "`TheGameOfSeekers(TM) of Fantastecha(TM)`": volunteering link:#hackers[hackers] would have their media (= "in between"s) mutated by the link:#the-devils[devils].
...
[[_history_lesson_about_the_muppeteers]]
== History Lesson: The Muppeteers

[[_history_of_earth_taylor]]
...
One complication was that in the Selinaverse, Taylor kept slaying all the other participants for vampire-slaying-tournaments in which she took parts.
...
[[_how_the_muppets_were_remastered]]
...
All the remaining post-puberty vampires (including Pope John Paul II) relocated to Rockville to become muppeteers and have their echoes mate with echoes of ones.
...
Cher organised many parties and other social events, and given she accumulated a lot of "stuff", and clothes, she usually agreed to promise to give them away on the spot (while naturally requesting to give her time to undress and change in relative privacy). 
...
All the remaining vampires were slain by Jim Henson (possibly indirectly). 
...
[[_the_terran_terminators__rematch]]
...
So my soul+mind were effectively created in September 1983, close to the first day of the 1st grade of elementary school with the body of a 6 years old. link:#Arnold_Schwarzenegger[Arnold Schwarzenegger] and others started their terminators' lives as grown-ups. 

I think it is possible that the drop-outs were "`punished`" by being soft-forked, i.e: beget a new offshoot with a similar mind, a different name, and a new soul.
So Selina Mandrake begot Séléna Mandriva, Jim Hensen begot Jimmy Wales, etc. 

[[_causes_shlomif_will_die_for]]
...
( References: https://www.shlomifish.org/meta/FAQ/#what_are_your_personality_faults["What are some of your personality faults/quirks?"] ) 

[[_why_shlomif_became_a_terminator]]
...
I also suspect Africa used to be one big country, and the USSR was not (Russia was a large country, with St.
...
Parts of Jerusalem ascended when https://en.wikipedia.org/wiki/Solomon[King Shlomo
...
David and his sons agreed he would be a better king and crowned him, while remaining physically alive and loyally serving under Shlomo`'s reign, thus undergoing https://en.wikipedia.org/wiki/Catharsis[Catharsis] and liberating parts of Jerusalem. footnote:[Note that in the Selinaverse, Vedek Winn
...
https://www.youtube.com/watch?v=_36yNWw_07g[Linus Torvalds To Nvidia - "`Fuck You`"]

[[_elizabeth_i_and_ii]]
=== Queens Elizabeth I and Elizabeth II (of England)

https://en.wikipedia.org/wiki/Elizabeth_I[Queen Elizabeth
I] was not really chaste just was slain before she was able to conceive vampire children, which made all her genetic children wizard-born.
"Virgin" among true prophets means a hacker that was slain before hitting puberty, including ones that were born wizards.
It is not an insult. 

https://en.wikipedia.org/wiki/Elizabeth_II[Queen Elizabeth II] was destined by link:#the-devils[theGamers(TM)] to be the last virgin-monarch-following-a-starting-as-a-vampire UK monarch.
...
[[_history_behind_the_scroll_of_esther]]
=== Behind the scroll of Esther

At the beginning of the Biblical https://en.wikipedia.org/wiki/Book_of_Esther[Scroll of Esther]: 

. Xerxes is the master vampire of Susa, which is a hell hole. And I think below puberty ( 13 y.o. ) and may think of Vashti and Esther as playmates rather than lovers/wives. 
. Vashti is a vampire. 
. Hadassah is a vampirella who was born in the Levant (or any remote hell hole wrt Susa). The Jewish tradition claimed she was 90 years old when she married Xerxes, which I don't find farfetched. 
. Mordechai is a foreign-born vampire too. 
. Haman is a wizard watcher, who aims to help get vampires slain. He is not malevolent, just possibly adverserial, and given his watcher and vampire ancestry has mixed genetical lineage. Him being a descendent of Amaleq, who may have been a myth, was a retrofitted "fact". 
+
I think "man"/"mann", at least in the end of one's last name, is indicative of being wizard-born. 

What happened was: 

. Xerxes slew Vashti. Given he was pre-pubescent, they did not beget a new vampire-pair of children. 
. Xerxes slew Hadassah. She became queen Esther, and the "s" and "t" in succession indicate her wizard-hood. 
+
Given Xerxes pre-pubescent, they did not beget a new vampire-pair of children. 
+
( While "`Esther`" is a variation of https://en.wikipedia.org/wiki/Inanna["Ishtar"], I think "sh" and "t" in succession are not indicative of being a wizard.
Long live the small difference.
) 
. Mordechai slew Xerxes, thus de-hell-holing Susa. Xerxes was still pre-pubescent at the time, so he became the last https://en.wikipedia.org/wiki/Achaemenid_dynasty[Achaemenid ["`Persian`"] dynasty] emperor to be born a vampire. And Susa will usually be avoided by post-puberty vampires, given it is no longer a hellhole. 
. Xerxes, Esther, Haman, & co. party, which involves supposed publicly hanging Haman and his family, non-mortal street fights, and what not. 

Given "`A vampire can only be slain by another vampire, except for the last standing vampire who will be slain by the child of his two favourite children.`" Xerxes and his descendents could no longer slay other vampires, including not foreign vampire leaders of other nations or link:#corporations[collectives] (who often were unaware of their elevated status). 

( This section was written as an update to https://shlomif.livejournal.com/62243.html[an old blog post titled "`Purim Special: The Ultimate Conspiracy Theory Behind the Story of the Scroll of Esther - Shlomi Fish's Journal -- LiveJournal`"].
This time I do not claim that this section, or the old post are the ultimate ones.
) 
...
[[_shlomif_watchers_and_whichers]]
...
However, at ~1997/1998, during my "great mania", I likely was pitted against many terminators during a short time, and the devils filled my head with fictional delusions.
...
Basicly, I was a pawn in TheGameOfSeekers(TM) because theGamers(TM) determined that Emma Watson will replace Hart. 
...
I recall that an IRC chatter linked to a photo of Watson when she was about 18 and I thought she looked beautiful and cute there. 
...
This model is temporary, and can and likely will get out-of-date, given his mind is dynamic. 

They are mainly concerned with preventing physical pain and peril. 

[[_operating_systems_history]]
...
This is because they have better tasks to accomplish with their time than go on a litigatious offence, which wastes time, good will, love, and reputation.
( References: ) 
...
When systems based on the Linux kernel emerged, they based their user-land software on GNU`'s wholesale. 
...
I suspect many of the POSIX-and-GNU-compatible kernels are figuratively gathering dust on software sharing sites and VCS repositories.
However, Linus Torvalds was serious about making the Linux kernel a more serious contender.
As opposed to Microsoft Windows, Linux assumes that offending user-land applications will be fixed; possibly by recompiling and/or patching the sources.
It does not have Windows`' "bug-to-bug backward-compatibllity" guarantee. 

I think the FreeBSD kernel is designed to support less exotic or professional hardware than the Linux kernel. 
...
+
Things I learnt from him included the revelation that good hacking often requires expending more resources than slacking footnote:[Like the adages go:] , and the https://www.shlomifish.org/meta/FAQ/#i_hate_one_of_your_works[importance of providing pinpointed, concrete, criticism]. 
...
[[_convergers_consolidators]]
== "`SysCo`"s: systems`' coordinators, collaborators, cooperators, consolidators, convergers, conventions, conferences ("Cons"). Bringing order (and simplicity) into madnesses. E.g:

"`SysCo`"s: systems`' coordinators, collaborators, cooperators, consolidators, convergers, conventions, conferences ("Cons"). Bringing order (and simplicity) into madnesses.
E.g: 

* Intel : 1 CPU, GPU, soundcard, network card, etc. standards for non-professionals. 
* SCO Unixware / Linux: https://www.shlomifish.org/humour/fortunes/show.cgi?id=sharp-linux-The-SCO-vs-Linux-TV-Series
** SGI [ = "Silicon Graphics Instruments" ] were nicknamed SCGI [ = "Silly Cons, Graphicians, and Instrumentalists" ] 
** https://www.shlomifish.org/humour/fortunes/show.cgi?id=clarissa-darling[Clarissa Darling] : ( x86 + UNIX ) -> ( POSIX, GNU, Linux, FreeBSD, Mac OS X ) 
+
I think SGI`'s hardware and software were open-source, but often the size of the sources was prohibitive. 
** When MS-DOS became Windows, the Microsoft Windows API was introduced, and eventually the Microsoft executives, agreed that it was nearly impossible to use. 
* DARPA/ARPA: "`When DARPA fails, whole industries spring up`". I think DARPA has a relatively small budget, and also outsource a lot. 
* conCERN: where HTTP/WorldWideWeb were invented 
* The smartphone wars: lawyers are often "showy" SysCo. They had to consolidate the legacy of 2-D geometry, 3-D geometry, many user-interfaces of desktop environments, smart devices, games, shells, etc. 
** They did not care about tariffs for violating patents. 
* AleppoCon: "the crown of Aleppo": https://en.wikipedia.org/wiki/Aleppo_Codex[The Aleppo Codex] is a "small" book with a "big ego". It put Aleppo on the map. 


[[_ultimatum_to_the_devils]]
...
My (= Shlomi Fish`'s) current mission in life is the resurrection of the dead.
I suspect the prerequisite for that is escaping my hell "world" which, assuming "supernatural" magic does not exist, defies reason, logic, arithmetics, ethics, and morality. 
...
* https://github.com/shlomif/shlomif-tech-diary/blob/master/tamar-v0.1.x-the-Shlomi-Fish-version.h[tentative fortified C sourcecode (kinda pseudocody) to "tam/tamar/tamara"] (my "evil" step-mother) - the scourge of vampire-hackers [and their non-illuminati wizards friends, watchers, witchers] playing TheGameOfSeekers(TM) of Fantastecha(TM). Serves several useful purposes. 
...
.. Software projects' activity: 
*** https://github.com/shlomif/pysol-cards-in-C[Embed pysol_cards in C]
...
** https://www.youtube.com/watch?v=cdhHOFv5suY[Hiromi - Pachelbel`'s Canon] - combining classical music and Jazz, two musical genres that I was under the impression have stagnated recently ( https://web.archive.org/web/20190427050055/http://esr.ibiblio.org/?p=4229[Reference] ). And it sounds great. 
...
** https://www.youtube.com/watch?v=awhyiBv-oQc[Kermit the Frog: Rainbow Connection]
...
.. "to be slain" -> "to die in TheGameOfSeekers(TM) Of Fantastecha(TM)" 
...
Shlomo David + Miryam (David?) -> Su'ad David + Ezra David 

Su'ad David + Falk Fish -> Shlomi (formerly "Shlomo") Fish + Michal Fish 
