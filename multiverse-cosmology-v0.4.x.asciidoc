...
TheCodex(TM) of TheGame(TM) of Fantastecha(TM) was kept secret from the link:#hackers[hackers (+++=+++ player characters)] of the Selinaverse and was to be revealed to the Terminal Terran Terminator (me?). 
...
. One can say "One doesn't simply not know who Marilyn Monroe is" ( https://www.shlomifish.org/humour/image-macros/#not_know_marilyn_monroe[Reference] ) instead of "practically every [ Selinaversan / terran / human / etc. ] hacker has heard of Marilyn Monroe and knows who she was" to piggy back on the https://knowyourmeme.com/memes/one-does-not-simply-walk-into-mordor/[snowclone quote, image-macro, and meme]. This will either make the message more amusing (and possibly more memorable), or if the recipients are not yet familiar with the meme, not hurt much. 
...
An Internet IM participant (with whom I chatted in modern Israeli Hebrew), and who tried to convince me that "God" may exist, despite me asking him "If God created the world, who created God?" ( https://www.shlomifish.org/philosophy/the-eternal-jew/ongoing-text.xhtml#godless_man[Reference] - largely inspired by "The Neo-Tech Cosmic Power [pincer #1]") told me that the most reasonable existence is that nothing had ever existed, or will have existed. 
...
Those who don't exist... well, either they will exist in the future, or they cannot reasonably be conscious, and have minds. 
...
( Conclusion: consider buying a tinfoil hat if you want to prepare for worst-case scenario, including a https://en.wikipedia.org/wiki/WarGames [thermonuclear war like the film "WarGames"] (rather than a https://github.com/shlomif/shlomif-tech-diary/blob/master/hydrogen-bombs-are-likely-an-old-intelligence-hoax.asciidoc[local sand splash] ), 

. https://terminator.fandom.com/wiki/Terminator_(franchise)[A Terminator franchise-style robot acolypse] (rather than https://www.youtube.com/results?search_query=return+jedi+ewoks+battle[clunky Imperial robots and droids] that can be defeated by Ewoks using wood, ropes, stones, ) 
...
. Co-hackers living in the same universe. 
. The para-Fantastechans. 
. The para-para-Fantastechans 
. The para-para-para-Fantastechans 
. his angels and devils 
. his role-playing-games characters (= "jews") or other "game pieces" 
. his characters' characters. 
. his very soul. 
. his mind, including the models he keeps in his mind of leaders (= guideline-generators). TheCodex(TM) calls these models "gods". This is whereas a "king" is a concrete, physically present leader (and who in the Shlomiverse can be a president, a prime minister, a secretary or a minister, a military commander (including those who are not generals), a dayjob boss or supervisor, a family member, an Internet forum operator, moderator or co-participant, etc. ). 
+
...
There were a few nights when there was too much noise and commotion outside my window, and while I felt a little vandalous, I only informed/complained to the police on the phone. 
...
I think now that outside my hell, the horse, who was/is a wizard hacker, was informed (via telepathy) of what I saw, thought, and my plan to try to avoid getting clobbered to pain.
He/she was instructed to play along, continue galloping at a somewhat slower pace, and then stay at the corner of the field. 

As a result, I think that if we accept the definition of "God" in TheCodex(TM) of TheGame(TM) of Fantastecha(TM), then they most probably exist, given practically every conscious-and-mindful Selinaverse-an organism, has some amount of self-control and guidance.
Planet Earth is not fully symmetric, which given https://en.wikipedia.org/wiki/Perfection#Paradoxes["Perfection is in imperfection"] would imply it would have been boring, if not completely lifeless.
However, there is a large amount of "law and order". 
