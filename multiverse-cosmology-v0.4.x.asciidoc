...
Still not perfect.
E.g: Rindolf was able to find many code elegance issues in my Perl source code.
...
It is a testament to Selinaverse-an technology that a https://www.shlomifish.org/me/business-card/["humorist, writer, and software geek"] (or a 'blogger' or a 'web monkey') is somehow comparable to them.
) 
